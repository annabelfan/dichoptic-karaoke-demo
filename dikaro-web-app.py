...
def hello_world():
    ...
    # Split text into three equal parts
    text_length = len(text_content)
    third = text_length // 3
    
    part1 = text_content[:third]
    part2 = text_content[third:2*third]
    part3 = text_content[2*third:]
    ...
    return render_template('index.html',
                         ...
                         part2=part2,
                         part3=part3,
                         color1=adjusted_color1,
                         color2=adjusted_color2,
                         color3=adjusted_color3,
